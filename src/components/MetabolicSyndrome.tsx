        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start max-w-7xl mx-auto">
          <div className="space-y-6">
            ...
            <Button
              ...
              className="bg-turquoise hover:shadow-lg hover:shadow-turquoise/10 transition-all duration-300 bg-white/90"
            >
              Saber mais
            </Button>
          </div>

          <Tabs defaultValue="obesidade" className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-8">
              <TabsTrigger value="obesidade">Obesidade</TabsTrigger>
              <TabsTrigger value="hiperinsulinemia">Hiperinsulinemia</TabsTrigger>
            </TabsList>

            <TabsContent value="obesidade">
              <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-lg hover:shadow-turquoise/10 transition-all duration-300 bg-white/90">
                {/* Infographic 1 */}
...
(4) THATCHER, C. D., PLEASAN T, R. S., GEOR, R. J. & ELVINGER, F. (2012) Prevalence of overconditioning in mature horses in southwest Virginia during thesummer. Journal of Veterinary Internal Medicine 26, 1413-1418.
            ...
            <TabsContent value="hiperinsulinemia">
