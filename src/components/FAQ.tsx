...
const faqItems = [
  {
    ...
    answer: "O lançamento oficial da Performance FIT está previsto ainda para 2025. Os participantes da lista VIP serão os primeiros a ter acesso ao produto e receberão condições especiais de pré-venda."
  },
  {
